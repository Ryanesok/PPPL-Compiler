...
class StorageService:
    ...
    def __str__(self):
        """String representation of StorageService"""
        return f"StorageService(ServiceID={self.ServiceID})"
    def to_dict(self):
        """Convert StorageService to dictionary"""
        return {
            'ServiceID': str(self.ServiceID) if self.ServiceID else None,
        }
    def validate(self) -> bool:
        """Validate StorageService data"""
